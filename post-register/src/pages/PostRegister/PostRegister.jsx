...
function PostRegister() {
    ...
    const [category, setCategoty] = useState('common');
            ...
            <div css={s.layout}>
                ...
                <aside css={s.sidebar}>
                    ...
                    <div css={s.submitButtonGroup}>
                        ...
                        <Button onClick={handeSubmitOnClick}><PiPaperPlaneTiltLight />발행하기</Button>
                    </div>
                </aside>
            </div>
        </div>
